...
export default class Index extends Component {
    render() {
        return <div className="main">
            <h1>React Boilerplate 2.0</h1>
            <h2>(Redux, React-Router 2.0, webpack, babel, npm, isomorphic, Karma, Mocha, enzyme)</h2>
            <p>Hello ! This is test boilerplate of <strong>React + Redux</strong></p>
            <p>This is little single page application can run isomorphic and include routing, todolist example and fetch data from <a href="https://restcountries.eu/">restcountries</a></p>
            <hr />
            <h3>Install:</h3>
